    ...
    <>
      <div className="container mx-auto px-4 flex items-start gap-[25px]">
        ...
        <div className="about_right bg-white py-[40px] px-[50px] mt-[20px] w-[714px]">
          <h2 className="font-bold text-[30px] mb-[17px]">Способы оплаты</h2>
          <p className="mb-[29px]">
          ...
          <p>
            Тарифы на доставку товаров по Ташкенту: <br />
             ...
             -20.000 сум для товаров до
            150.000 сум -Бесплатная доставка для всех товаров от 150.000 сум <br />
            Тарифы на доставку товаров по всех регионов: <br /> -Платная доставка для
            всех товаров по согласованной цене <br /> -Бесплатная установка для всех
            тренажеров
          </p>
        </div>
      </div>
