      ...
      <div className="flex justify-around relative flex-wrap gap-4 md:gap-8">
        {data.map((product: any) => (
          <div key={product.product_id} className="relative">
            <div className="w-[280px] h-[380px] bg-white flex flex-col items-center rounded-md justify-between relative shadow-md">
              <div className="absolute right-[20px] top-[20px] cursor-pointer">
                <HeartOutlined />
              </div>
              <div className="w-[180px] h-[214px] grid justify-center items-center z-[999]">
                <Image
              ...
              <Link
                ...
                className="py-[10px] w-full  bg-[#FBD029] rounded-b-md text-center text-[14px] sm:text-[16px] md:text-[18px]"
              >
                Корзина
              </Link>
            </div>
